...
from data.Synthetic_data.equi_con_Linear_version import dgp
...
def icevae_equ_con(epochs=200,hidden_dim=32,batch_size=50,lr=1e-3,latent_dim=10):
...
if __name__ == '__main__':
    PEHE_mean, PEHE_std, MSEmean, MSEstd = icevae_equ_con(epochs=200, hidden_dim=128, batch_size=50,lr=0.001, latent_dim=10)