...
from data.semi_Synethic_data_TWINs import newDGP
...
if __name__ == '__main__':
    ...
    for i in range(num_experiments):
        ...
        parser.add_argument('-e', '--epochs', type=int, default=300, help='number of epochs (default 20)')
        parser.add_argument('-g', '--hidden-dim', type=int, default=256, help='hidden dim of the networks (default 50)')
        ...
        model=ICEVAE(U.shape[1], args.latent_dim, X.shape[1], 1, 7, 1,hidden_dim=args.hidden_dim, device=device,layer_norm=False,activation_exit=True,layer_nums=3,bin_using_sigmoid=True)
        ...
        scheduler_obs =  torch.optim.lr_scheduler.ExponentialLR(optimizer_obs, gamma=0.999)
        scheduler_exp =  torch.optim.lr_scheduler.ExponentialLR(optimizer_exp, gamma=0.99)
